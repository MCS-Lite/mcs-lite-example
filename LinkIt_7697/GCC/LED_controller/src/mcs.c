...
void mcs_upload_datapoint(char *value, char *api_server, int api_port, char *device_id, char *device_key)
{
    /* compose the request url*/
    char http_request_url[70] = {0};
    char api_port_s[10];
    strcat(http_request_url, "http://");
    strcat(http_request_url, api_server);
    strcat(http_request_url, ":");
    sprintf(api_port_s, "%d", api_port);
    strcat(http_request_url, api_port_s);
    strcat(http_request_url, "/api/devices/");
    ...
    strcat(post_url, http_request_url);
